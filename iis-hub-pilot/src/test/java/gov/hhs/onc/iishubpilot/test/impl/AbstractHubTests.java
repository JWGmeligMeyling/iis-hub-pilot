...
@ContextConfiguration(initializers = { HubApplicationContextInitializer.class }, locations = { "classpath*:WEB-INF/spring/spring-hub.xml",
    "classpath*:WEB-INF/spring/spring-hub-*.xml" })
